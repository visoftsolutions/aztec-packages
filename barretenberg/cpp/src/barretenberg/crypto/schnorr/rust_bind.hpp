...
WASM_EXPORT const char* schnorr_negate_public_key(affine_element::in_buf public_key_buffer,
...
WASM_EXPORT const char* schnorr_multisig_create_multisig_public_key(
    fq::in_buf private_key, multisig::MultiSigPublicKey::out_buf multisig_pubkey_buf);
