...
WASM_EXPORT const char * schnorr_compute_public_key(fr::in_buf private_key, affine_element::out_buf public_key_buf);
WASM_EXPORT const char * schnorr_negate_public_key(affine_element::in_buf public_key_buffer, affine_element::out_buf output);

WASM_EXPORT const char * schnorr_construct_signature(uint8_t const* message, fr::in_buf private_key, out_buf32 s, out_buf32 e);
...
WASM_EXPORT const char * schnorr_multisig_create_multisig_public_key(fq::in_buf private_key,
