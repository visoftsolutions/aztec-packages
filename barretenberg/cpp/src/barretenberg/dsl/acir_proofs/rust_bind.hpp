...
const char* rust_acir_get_circuit_sizes(uint8_t const* constraint_system_buf,
                                        uint32_t* exact,
                                        uint32_t* total,
                                        uint32_t* subgroup);
...
const char* rust_acir_create_circuit(in_ptr acir_composer_ptr,
                                     uint8_t const* constraint_system_buf,
                                     uint32_t const* size_hint);

const char* rust_acir_init_proving_key(in_ptr acir_composer_ptr, uint8_t const* constraint_system_buf);
...
const char* rust_acir_get_proving_key(in_ptr acir_composer_ptr, uint8_t const* acir_vec, uint8_t** out);
